...
class ProfileUser extends StatefulWidget {
  ...
  final detail_image;
  final detail_imagee;
  final detail_imageee;
  final detail_imageeee;
  final detail_ctiy;
   final detail_cat;
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Column(
                          ...
                          children: <Widget>[
                            Text("محمد الفاتح",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: fromSize(40,context)),),
                            Row(
          ...
          child: Container(
            decoration: BoxDecoration(
                gradient: LinearGradient(
                    colors: [
                       Color(0xFFfc5e5f).withOpacity(0.4),
                      Color(0xFFfc5e5f).withOpacity(0.4)
                    ],
                        ...
                        Container(
                          ...
                          child: ListView(
                            ...
                            children: [
                              ...
                              ItemCategory(
                                image: Image.network(widget.detail_imagee,filterQuality: FilterQuality.high,fit: BoxFit.cover,),
                                
                              ),

                              Container(width: fromRealWidth(3, context),),
                              ItemCategory(
                                image: Image.network(widget.detail_imageee,filterQuality: FilterQuality.high,fit: BoxFit.cover,),
                               
                              ),

                              Container(width: fromRealWidth(3, context),),
                              ItemCategory(
                                image: Image.network(widget.detail_imageeee,filterQuality: FilterQuality.high,fit: BoxFit.cover,),
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              leading: CircleAvatar(backgroundColor: Colors.white, backgroundImage: ExactAssetImage("assets/gift.jpg"), radius: fromRealWidth(10,context),),
  trailing:Container(
    child: Text(snapshot.data[i]['post_uesr'].toString(),)),
              title:Text(snapshot.data[i]['post'],),
              subtitle: RatingBar
              (
                onRatingChanged: (rating){    
                        },
...
setState(() {
  ...
  Future apppost() async {
    var url = "http://dzs.rcl.mybluehost.me/oscar/api/apppost.php" ;
    var data = {"post" : _addpost.text, "post_uesr" : customer, "rating" : _rating.toString(),} ;
