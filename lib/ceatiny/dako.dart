...
// class Dako extends StatefulWidget {
//   @override
//   _DakoState createState() => _DakoState();
// }

// class _DakoState extends State<Dako> {
...
//                       image:AssetImage('images/cats/nn.jpg'),
//                       fit: BoxFit.cover,
//                     ),
//                   ),
//                   child: Container(
...
//                 child: Container(
//       margin: EdgeInsets.only(left: 30,right: 6),
//       child: Stack(
//         overflow: Overflow.visible,
//         children: [
//           Positioned(right: 25,bottom: 5,top: 3,left: 2,
//             child: Container(
...
//                               Row(
//                                 children: [
//                                   Text("ديكوري",style: TextStyle(color: Colors.black,shadows: [
//                                     BoxShadow(color: Colors.grey.withOpacity(0.5),blurRadius: 5),
